...
(function ($) {
    ...
    Photos.prototype = {
        ...
        open: function (index) {
            ...
            this.modal.addClass('ui-photo-browser-modal-visible');
        ...
        close: function () {
            ...
            this.modal.removeClass('ui-photo-browser-modal-visible');
        },
        ...
        onClick: function () {
            var self = this;
            if (this.-lastClickTime && (+new Date - this.-lastClickTime < 300)) {
                this.onDoubleClick();
        ...
        adjust: function () {
            if (!this.-needAdjust) return false;
            var img = this.gestureImage;
            if (!img) return false;
            if (this.currentScale === 1) {
                this.imageTransform = this.imageLastDiff = {
                    x: 0,
                    y: 0
                };
                this.doImageTransform(200);
            ...
            this.doImageTransform(200);
            this.-needAdjust = false; // must at last line, because doImageTransform will set this.-needAdjust true
        },
    ...
    defaults = Photos.prototype.defaults = {
        ...
        tpl: '<div class="ui-photo-browser-modal">\
